...
|---|---:|---:|---:|---:|---:|
| 3 distance sensors | 75 deg | $90 | 53% | 49% | 26% |
| 4 distance sensors | 100 deg | $120 | 53% | 49% | 26% |
| 6 distance sensors | 150 deg | $180 | 48% | 44% | 27% |
| 8 distance sensors | 200 deg | $240 | 43% | 44% | 30% |
...
## The direct head-to-head: ~$90 of blind cones vs. ~$100 of full coverage

Lidar (360deg coverage, $100) has a 44% zero-deviation collision rate, vs. 49% for the headline 3-sensor DistanceSensorSuite at $90 -- a real improvement, though not a complete elimination of geometry-driven collisions (some of DistanceSensorSuite's collision rate was never purely a coverage-angle problem -- see ftc_suite_writeup.md's own controlled check, which found roughly a third of collisions persisted even with pose drift disabled for reasons other than blind spots).
