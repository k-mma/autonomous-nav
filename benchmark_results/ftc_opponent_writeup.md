...
| AprilTag (front camera) | $25 | 17% | 52% | +36% |
| IMU | $0 | 8% | 26% | +18% |
| Rear camera | $50 | 17% | 49% | +32% |
| Full suite | $399 | 74% | 74% | +1% |

## Best value by blocker type

Static: AprilTag (front camera) (+34.0pp/$100, baseline 8%). Moving: AprilTag (front camera) (+90.0pp/$100, baseline 30%).

A moving opponent doesn't change which suite wins -- AprilTag (front camera) is the best-value suite against both a static and a moving obstacle. Modeling the opponent as a random walk instead of a fixed point changes the raw numbers (see the table above) but not the recommendation.
...
| AprilTag (front camera) | 0.74 | 0.35 | 3.20 | 4.82 |
| IMU | 0.75 | 0.49 | 0.00 | 0.00 |
| Rear camera | 0.74 | 0.40 | 3.20 | 4.69 |
